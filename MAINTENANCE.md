...
2. Ensure you build and release macOS packages within your GitHub Actions workflow, with the following artifact names:

    - `<package_name>_darwin_amd64.deb`
    - `<package_name>_darwin_arm64.deb`
